...
class EmptemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emptemperature" do
    assert_difference('Emptemperature.count') do
      post emptemperatures_url, params: { emptemperature: { address: @emptemperature.address, day_and_time: @emptemperature.day_and_time, done_by: @emptemperature.done_by, full_name: @emptemperature.full_name, phone: @emptemperature.phone, symptoms: @emptemperature.symptoms, temperature: @emptemperature.temperature } }
    end
  ...
  test "should update emptemperature" do
    patch emptemperature_url(@emptemperature), params: { emptemperature: { address: @emptemperature.address, day_and_time: @emptemperature.day_and_time, done_by: @emptemperature.done_by, full_name: @emptemperature.full_name, phone: @emptemperature.phone, symptoms: @emptemperature.symptoms, temperature: @emptemperature.temperature } }

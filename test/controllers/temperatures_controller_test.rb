...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { address: @temperature.address, checked_at: @temperature.checked_at, checked_by: @temperature.checked_by, full_name: @temperature.full_name, phone: @temperature.phone, status: @temperature.status, temperature: @temperature.temperature } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { address: @temperature.address, checked_at: @temperature.checked_at, checked_by: @temperature.checked_by, full_name: @temperature.full_name, phone: @temperature.phone, status: @temperature.status, temperature: @temperature.temperature } }
